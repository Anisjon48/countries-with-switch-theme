...
import { selectnNeighbors } from '../store/details/details-selector';
            ...
            <div>
                ...
                <Meta>
                    ...
                    {!borders.length ? (
                        ...
                        <TagsGroup>
                            {!neighbors.length ? (<span>Loading...</span>) : neighbors.map(countryName => (
                                <Tag key={countryName} onClick={() => push(`/country/${countryName}`)}>{countryName}</Tag>
                            ))}
                        </TagsGroup>
                    )}
                </Meta>
